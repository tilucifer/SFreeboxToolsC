...
public class FbxGetDownload extends FbxHttpRaster implements Cloneable{
	public static Logger log = LoggerFactory.getLogger(FbxGetDownload.class);

	private Integer dwl_id;
	
	public FbxGetDownload(String url, int method, AbstractActivity activity) {
		super(url, method, activity);
	}
	public FbxGetDownload(String url, int method, AbstractTask task) {
		super(url, method, task);
	}
	public FbxGetDownload(String url, int method, Follower follower) {
